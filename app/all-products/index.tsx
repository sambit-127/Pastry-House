...
type Category = "All" | "Cakes" | "Pastries" | "Donuts" | "Breads"|"Cookies";
...
const SAMPLE_PRODUCTS: Product[] = [
    ...
    },
    {
        ...
        image: require('@/assets/images/pastry/donut1.jpg'),
        category: "Donuts",
        price: 59,
        rating: 4.3,
        dietary: "veg",
    ...
    },
    {
        ...
        image: require('@/assets/images/pastry/bakery6.jpg'),
        category: "Breads",
        price: 129,
        rating: 4.5,
        dietary: "vegan",
    ...
    },
    {
        ...
        image: require('@/assets/images/pastry/donut2.jpg'),
        category: "Donuts",
        price: 69,
        rating: 4.1,
        dietary: "veg",
    ...
    },
    {
        ...
        image: require('@/assets/images/pastry/bread1.jpg'),
        category: "Breads",
        price: 99,
        rating: 4.0,
        dietary: "vegan",
...
const CATEGORIES: Category[] = ["All", "Cakes", "Pastries", "Donuts", "Breads","Cookies"];
...
const AllProducts: React.FC = () => {
    ...
    const initialCategory = useMemo(() => {
        ...
        const formatted = String(category);
        const found = CATEGORIES.find(
            (c) => c.toLowerCase() === formatted.toLowerCase()
        );
        return (found as Category) ?? "All";
    }, [category]);
    ...
    // Keep state in sync when the incoming route param changes
    useEffect(() => {
        const formatted = String(category || "");
        const found = CATEGORIES.find(
            (c) => c.toLowerCase() === formatted.toLowerCase()
        );
        setSelectedCategory((found as Category) ?? "All");
    }, [category]);
